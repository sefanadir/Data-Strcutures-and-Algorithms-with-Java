...
public class AVLTree< E extends Comparable< E>> extends BinarySearchTreeWithRotate< E> {
    ...
    private boolean addBinaryTreeToAVL(BinaryTree<E> tree) {
        if (tree != null) {
            add(tree.getData());
            addBinaryTreeToAVL(tree.getLeftSubtree());
            addBinaryTreeToAVL(tree.getRightSubtree());
        }
        return false;
    }
     ...
     */
    /**
     * Delete starter method. Removes the given object from the AVL tree.
     *
     ...
     * or decrease.
     *
     * @pre The balance field was correct prior to an insertion or removal, and
     * an item is either been added to the right or removed from the left.
     * @post The balance is incremented and the increase and decrease flags are
     * set to false if the overall height of this subtree has not changed.
     ...
     */
    /**
     * Method to rebalance left. pre: localRoot is the root of an AVL subtree
     * that is critically left-heavy. post: Balance is restored.
     *
     * @param localRoot Root of the AVL subtree that needs rebalancing
     * @return a new localRoot
     */
    private AVLNode< E> rebalanceLeft(AVLNode< E> localRoot) {
        ...
        if (leftChild.balance > AVLNode.BALANCED) {
            ...
            /**
             * In this case the leftChild (the new root) and the root (new right
