...
public class RedBlackTree< E extends Comparable< E>> extends BinarySearchTreeWithRotate< E> {
    ...
    private static class RedBlackNode< E>
        ...
        // Constructor
        /**
         * Create a RedBlackNode with the default color of red and the given
         * data field.
         *
        ...
        // Methods
        /**
         * Return a string representation of this object. The color (red or
         * black) is appended to the node�s contents.
         *
    ...
    // Data Field
    /**
     * A boolean variable to indicate that the black height was reduced by a
     * call to the recursive delete method or one of its submethods.
     */
     ...
     */
    /**
     * Delete starter method. Removes the given object from the binary search
     * tree. Post: The object is not in the tree
     *
     * @param item - The object to be removed.
     * @return The object from the tree that was removed or null if the object
     * was not in the tree.
     */
    @Override
    ...
    /**
     * Recursive remove from left sub-tree method. Removes the given object from
     * the binary search tree. Pre: The values of parent and parent.left are are
     * not null The object is less than parent.data
     *
     * @post The object is removed from the tree
     * @param parent - Parent of the root of the subtree
     * @param item - The object to be removed
     * @return The object that was removed or null if the item is not in the
     * tree
     */
    ...
    /**
     * Recursive remove from right sub-tree method. Removes the given object
     * from the binary search tree.
     *
     * @pre The values of parent and parent.right are not null The object is
     * greater than parent.data
     * @post The object is removed from the tree
     * @param parent - Parent of the root of the subtree
     * @param item - The object to be removed
     * @return The object that was removed or null if the item is not in the
    ...
    /**
     * Function to find a replacement for a node that is being deleted from a
     * binary search tree. If the node has a null child, then the replacement is
     * the other child. If neither are null, then the replacement is the largest
     * value less than the item being removed.
     *
     * @pre node is not null
     * @post a node is deleted from the tree
     * @param node The node to be deleted or replaced
     * @return null if both of node's children are null node.left if node.right
     * is null node.right if node.left is null modified copy of node with its
     * data field changed
     */
     ...
     *
     * @post The found node is removed from the tree and replaced by its left
     * child (if any)
    ...
    /**
     * Method to restore black balance to a subtree whose right black height is
     * currently one less than the left black height.
     *
    ...
    /**
     * Method to restore black balance to a subtree whose left black height is
     * currently one less than the right black height.
     *
     * @param localRoot - The root of the tree needing fixing
     * @return A new local root
     */
