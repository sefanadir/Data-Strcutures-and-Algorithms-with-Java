...
public class QuickSort {
    ...
    /**
     * Sort the table using the quick sort algorithm. pre: table contains
    ...
    /**
     * Sort a part of the table using the quick sort algorithm. post: The part
     * of table from first through last is sorted.
     *
     * @param table The array to be sorted
    ...
    /**
     * Partition the table so that values from first to pivIndex are less than
     * or equal to the pivot value, and values from pivIndex to last are greater
