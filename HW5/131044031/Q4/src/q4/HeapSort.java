...
public class HeapSort {
    ...
    /**
     * Sort the array using heap sort algorithm. pre: table contains Comparable
     * items. post: table is sorted.
     *
     * @param <T> generic
    ...
    /**
     * buildHeap transforms the table into a heap. pre: The array contains at
     * least one item. post: All items in the array are in heap order.
     *
    ...
    /**
     * shrinkHeap transforms a heap into a sorted array. pre: All items in the
     * array are in heap order. post: The array is sorted.
     *
     * @param table The array to be sorted
     */
