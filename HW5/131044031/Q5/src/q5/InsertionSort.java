...
public class InsertionSort {
    ...
    /**
     * Sort the table using insertion sort algorithm. pre: table contains
    ...
    /**
     * Insert the element at nextPos where it belongs in the array. pre: table[0
     * . . . nextPos - 1] is sorted. post: table[0 . . . nextPos] is sorted.
     *
